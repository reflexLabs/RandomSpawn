    ...
    public void sendHelp(CommandSender sender) {
        if (sender.hasPermission("randomspawn.help") || sender.hasPermission("randomspawn.*") || sender.isOp()) {
           ...
           if(sender.hasPermission("randomspawn.*") || sender.isOp()) {
        	   ...
        	   sender.sendMessage(Functions.formatMessage("&f» &2/RandomSpawn &7Teleport [point] &8[player]: &fTeleports to specified spawn point"));
        	   sender.sendMessage(Functions.formatMessage("&f» &2/RandomSpawn &7Force [player]: &fTeleports specified player to random spawn point"));
